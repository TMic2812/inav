...
typedef enum {
    ...
    NAV_FSM_EVENT_SWITCH_TO_ATK_FINISHED = NAV_FSM_EVENT_STATE_SPECIFIC_2,
...
typedef enum {
    ...
    NAV_STATE_ATK_INITIALIZE,                   // 34
    NAV_STATE_ATK_IN_PROGRESS,                  // 35
    NAV_STATE_ATK_FINISHED,                     // 36
